...
%% Neutron Star
source.NeutronStar.Mass1 = 1.4;	% 1.4 Solar Mass
source.NeutronStar.Mass2 = 1.4; % 1.4 Solar Mass
source.NeutronStar.Distance = 23; % Megaparces

%% White Dwarf/Neutron Star - BS April 2012
% number form the low freq paper
% source.NeutronStar.Mass1 = 0.5;	% to mimic a White Dwarf, Solar Mass
% source.NeutronStar.Mass2 = 1.4; % Solar Mass
% source.NeutronStar.Distance = 23/1.6; % Megaparces, reduced?
