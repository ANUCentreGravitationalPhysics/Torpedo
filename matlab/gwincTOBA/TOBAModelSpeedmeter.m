% TOBAModelSpeedmeter adds parameters related to the speedmeter
...
function ifo = TOBAModelSpeedmeter(varargin)

  %% Default-----------------------------------------------------------------
  ifo = TOBAModel(varargin{:});
  
  %% Optics------------------------------------------------------------------
  ifo.Optics.Type = 'Speedmeter';
  
  ifo.Optics.SRM.CavityLength   = 15;           % m; ITM to SRM distance
