...
ifo = IFOModelSpeedmeter;
  ...
  ifo.Squeezer.SQZAngle         = 92*pi/180;   % SQZ phase [radians]
  
  % Parameters for frequency dependent squeezing
  ifo.Squeezer.FilterCavity.fdetune = -18;  % detuning [Hz]
  ifo.Squeezer.FilterCavity.L   = 4000;          % cavity length
  ifo.Squeezer.FilterCavity.Ti  = 22e-3;     % input mirror transmission [Power]
...
% ---- after tuning, put these parameters back into IFOModelSpeedmeter
  ...
  ifo.Optics.OCM.Transmittance  = 0.05;        % Transmittance of output coupler 
  
  ifo.Optics.SLM.Loss           = 37.5e-6;      % Scatter Loss of SLM
  
  ifo.Optics.SRM.Tunephase      = 0.0;         % SRM tuning
  ifo.Optics.Quadrature.dc      = 9*pi/180;    % demod/detection/homodyne phase
...
title('Speedmeter   w/ Freq. Independent  10 dB Squeezing  ')
%ylim([3e-25 2e-21])

orient tall
print -dpng nomm_sm.png
