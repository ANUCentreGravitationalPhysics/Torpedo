...
% Y - axis
% wy0 = 120.2um (raduis) @ 0.792mm 
% X - axis
% wx0 = 93.4um (radius) @ 0.75mm
%
% lens at 425.6mm and 300mm from laser aperture
%
% Laser head
% wy0 = 120.2um at 66.4mm down stream from aperture
% wx0 = 93.4um at 24.4mm down stream from aperture
%
...
%
Zy = 425.6*mm; % distance from lens to measured Y-waist
%
...
w0xs = 147.9*um;
Zwx = Zy - 508*mm;        % distance of the X-waist to the lens, from the BeamScan results
