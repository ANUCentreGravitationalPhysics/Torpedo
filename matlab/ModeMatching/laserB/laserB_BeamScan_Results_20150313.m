...
% Y axis: 105mm inside the laser head, wy = 135um
% X axis: 113.3mm insdie the laser head, wx = 120.5um
%
...
%
Zy = 800.5*mm; % distance from lens to measured Y-waist
%
R3 = 128.8*mm;  % imaging lens radius (with focal length of f=265mm
...
Zl = Zy + 250*mm;
ALSypath.addComponent(component.flatMirror(Zl, 'Laser Aperture'))
...
w0xs = 221*um;
Zwx = Zy - 782.8*mm;        % distance of the X-waist to the lens, from the BeamScan results
