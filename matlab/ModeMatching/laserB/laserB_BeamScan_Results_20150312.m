...
%
Zy = 278.7*mm; % distance from lens to measured Y-waist
%
R3 = 77.3*mm;  % imaging lens radius (with focal length of f=200mm
...
w0xs = 91.6*um;
Zwx = Zy - 277.4*mm;        % distance of the X-waist to the lens, from the BeamScan results
