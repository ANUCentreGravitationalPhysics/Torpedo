...
fileName = ['LaserB_MM_InTo_AOM_', datestr(now, 'yyyymmdd')];
...
Z5 = Z4b + 300*mm
R3 = 125*mm;
ALSypath.addComponent(component.lens(R3/(n-1), Z5, 'L4-f=212'));
%
Z6 = Z5 + 450*mm;
ALSypath.addComponent(component.flatMirror(Z6, 'AOM 1205C-843'))
%
Z7 = Z6 + 200*mm;
ALSypath.addComponent(component.flatMirror(Z7, 'RETRO - ROC=-250'))
%
...
% slide components to optimize mode overlap.
 ALSypath = ALSypath.optimizePath('L4-f=212', [Z4b Z7]);
