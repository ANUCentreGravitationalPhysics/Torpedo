...
TOBAV9SimData = TOBALoadValsV9('SweepValuesUsedReFS.dat','SweepValuesUsedImFS.dat');
TOBAV9SimData.Freq = dlmread('FreqSweep.dat');

% The Bar 1 & Bar 2 Trans are complex but saved in two files 
Bar1TransRe = dlmread('SweepBar1ReFS.dat');
Bar1TransIm = dlmread('SweepBar1ImFS.dat');
Bar1Trans = Bar1TransRe + 1i.*Bar1TransIm;

Bar2TransRe = dlmread('SweepBar2ReFS.dat');
Bar2TransIm = dlmread('SweepBar2ImFS.dat');
...
if SaveStructure
    ...
    save('TorpedoV9Si.mat','Experiament');
end
