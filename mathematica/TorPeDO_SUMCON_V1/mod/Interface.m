...
TableForm[{
(*---1. Registrate Rigid Bodies---*)
Item[Pane[Style["Step 1. Registrate Rigid Bodies",
...
(*---2. Set Connection---*)
Item[Pane[Style["Step 2. Set Connection",
Bold,Italic,White],ImageSize->{870,30},Alignment->{Left,Center}],
...
(*Set Wires*)
Button[Style["2-1 \nSet Wires",Bold,Black],mod$SetWires,
Appearance->"FramedPalette",Alignment->{Left,Center},
Background->RGBColor[0.6,1,0.6],ImageSize->200],
Button[Style["2-2 \nSet Vertical Springs",Bold,Black],mod$SetVertSprings,(*Set Mass % MoI*)
Appearance->"FramedPalette",Alignment->{Left,Center},
Background->RGBColor[0.6,0.9,0.6],ImageSize->200],
Button[Style["2-3 \nSet Inverted Pendulum",Bold,Black],mod$SetIP,(*Set Body Shapes*)
Appearance->"FramedPalette",Alignment->{Left,Center},
Background->RGBColor[0.6,0.8,0.6],ImageSize->200],
Button[Style["2-4 \nSet Heat Links",Bold,Black],mod$SetHeatLinks,(*Set Body Shapes*)
Appearance->"FramedPalette",Alignment->{Left,Center},
Background->RGBColor[0.6,0.7,0.6],ImageSize->200],
Button[Style["2-5 \nSet Damper",Bold,Black],mod$SetDamper,(*Set Body Shapes*)
Appearance->"FramedPalette",Alignment->{Left,Center},
...
(mod$StartCalc;calcdone=True;tabviewctrl=2;),(*Set Body Names*)
...
CreateDialog[{
(*---Title---*)
TextCell[Style["Registrate Body Names",
Bold,Italic,Black],Background->RGBColor[0.6,0.6,1]],
(*---Load List---*)
Module[{nMax=30,len},
If[ValueQ[save$bdn],len=Length[save$bdn];
If[len<nMax,(*If saved list exists, load it*)
temp$bdn=Join[save$bdn,Table[{False,""},{nMax-len}]],
temp$bdn=save$bdn[[1;;nMax]]],(*If not, create new one*)
...
InputField[With[{n=n},Dynamic[temp$bdn[[n,2]]]],String,FieldSize->{5.,1.}]},
...
save$bdn=DeleteCases[DeleteCases[temp$bdn,{False,""}],{True,""}]]],
...
CreateDialog[{
(*---Title---*)
TextCell[Style["Set Mass and Moment of Inertia",
...
temp$masscopy=temp$mass[[n]],ImageSize->Small]],
With[{n=n},Button[Style["Paste",Small],
If[ValueQ[temp$masscopy],temp$mass[[n]]=temp$masscopy],ImageSize->Small]],
(*Mass & Diagonal MoI*)
InputField[With[{n=n},Dynamic[temp$mass[[n,1]]]],
Number,FieldSize->{5.,1.},Enabled->Not[save$bdn[[n,1]]]],
InputField[With[{n=n},Dynamic[temp$mass[[n,2,1,1]]]],
Number,FieldSize->{5.,1.},Enabled->Not[save$bdn[[n,1]]]],
InputField[With[{n=n},Dynamic[temp$mass[[n,2,2,2]]]],
Number,FieldSize->{5.,1.},Enabled->Not[save$bdn[[n,1]]]],
InputField[With[{n=n},Dynamic[temp$mass[[n,2,3,3]]]],
Number,FieldSize->{5.,1.},Enabled->Not[save$bdn[[n,1]]]],
(*MoI Off-Diangonal Part*)
Opener[With[{n=n},Dynamic[temp$massopn[[n]]]]],PaneSelector[{
False->"Off-Diag",
True->TableForm[Table[InputField[With[{n=n,m=m,l=l},
Dynamic[temp$mass[[n,2,m,l]]]],Number,ImageSize->70.,FieldSize->{5.,1.},Enabled->Not[save$bdn[[n,1]]]],{l,3},{m,3}],
...
Beep[];CreateDialog[
{"Mass and diagnal parts of MoI matrices should be positive number.",
DefaultButton[]},WindowTitle->"Error"];,
DialogReturn[save$mass=temp$mass]]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},(*Cancel Button*)
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},
...
(*Copy & Past*)
With[{n=n},Button[Style["Copy",Small],
temp$shapecopy=temp$shape[[n]],ImageSize->Small]],
With[{n=n},Button[Style["Paste",Small],
If[ValueQ[temp$shapecopy],temp$shape[[n]]=temp$shapecopy],ImageSize->Small]],
(*Select Menu*)
...
Table[InputField[With[{n=n,m=m},
Dynamic[temp$shape[[n,2,m]]]],Number,FieldSize->{3.,1.}],{m,5}]}],
(*Opener*)
...
DialogReturn[save$shape=temp$shape]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},(*Cancel Button*)
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},
...
InputField[With[{n=n},Dynamic[temp$initpos[[n,1]]/mm,
(temp$initpos[[n,1]]=#*mm)&]],Number,FieldSize->{8.,1.}],
InputField[With[{n=n},Dynamic[temp$initpos[[n,2]]/mm,
(temp$initpos[[n,2]]=#*mm)&]],Number,FieldSize->{8.,1.}],
InputField[With[{n=n},Dynamic[temp$initpos[[n,3]]/mm,
(temp$initpos[[n,3]]=#*mm)&]],Number,FieldSize->{8.,1.}]},{n,len0}],
TableAlignments->Center,
...
(*---New Material Button---*)
Button[Style["Resistrate New Material",White,Bold],
...
{"Del","Copy","Name","Dens[g/cm3]","E [GPa]","Poisson","Loss","MEMO"}}]
],
(*---Save & Cancel Button---*)
TableForm[{{Button[Style["Save",Bold],
...
(* ***********************Version 1.2******************************** *)
(*Wire Version 1.2 Compriance Check*)
Do[
...
(*Delete Button*)
With[{n=n},Button[Style["Delete",Small],
temp$wire=Delete[temp$wire,{n}],ImageSize->Small]],
With[{n=n},Button[Style["Copy",Small],
AppendTo[temp$wire,temp$wire[[n]]],ImageSize->Small]],
(*Name*)
InputField[With[{n=n},Dynamic[temp$wire[[n,13]]]],String,FieldSize->{8.,1.}],
(*Upper Body*)
PopupMenu[With[{n=n},Dynamic[temp$wire[[n,1]]]],
Table[m->save$bdn[[m,2]],{m,Length[save$bdn]}]],
(*Upper SP*)
TableForm[{Table[InputField[With[{n=n,m=m},
Dynamic[temp$wire[[n,2,m]]/mm,(temp$wire[[n,2,m]]=#*mm)&]],
Number,FieldSize->{4.,1.}],{m,3}]}],
(*Lower Body*)
...
(*Length*)
InputField[With[{n=n},Dynamic[temp$wire[[n,6]]]],Number,FieldSize->{5.,1.}],
(*Diameter*)
InputField[With[{n=n},Dynamic[temp$wire[[n,7]]/mm,
(temp$wire[[n,7]]=#*mm)&]],Number,FieldSize->{5.,1.}],
(*Neck L*)
InputField[With[{n=n},Dynamic[temp$wire[[n,8]]/mm,
(temp$wire[[n,8]]=#*mm)&]],Number,FieldSize->{5.,1.}],
(*Neck D*)
InputField[With[{n=n},Dynamic[temp$wire[[n,9]]/mm,
(temp$wire[[n,9]]=#*mm)&]],Number,FieldSize->{5.,1.}],
(*Tension*)
InputField[With[{n=n},Dynamic[temp$wire[[n,10]]]],Number,FieldSize->{5.,1.}],
(*Upper Clamp Vector*)
TableForm[{Table[InputField[With[{n=n,m=m},
Dynamic[temp$wire[[n,11,m]]]],Number,FieldSize->{4.,1.}],{m,3}]}],
(*Lower Clamp Vector*)
TableForm[{Table[InputField[With[{n=n,m=m},
Dynamic[temp$wire[[n,12,m]]]],Number,FieldSize->{4.,1.}],{m,3}]}],
(*Longitudinal Stiffness*)
InputField[With[{n=n},Dynamic[temp$wire[[n,14]]]],Number,FieldSize->{7.,1.}],
(*Torsional Stiffness*)
InputField[With[{n=n},Dynamic[temp$wire[[n,15]]]],Number,FieldSize->{7.,1.}]
},{n,Length[temp$wire]}],TableHeadings->{None,
{"Del","Copy","Name","U Body","U Clamp Pos [mm]","L Body","L Clamp Pos [mm]","Mat",
"E [GPa]","Poission R","Loss [rad]","L [m]","D [mm]","NL [mm]","ND [mm]","T [N]",
"Upper Clamp Direction","Lower Clamp Direction","ks [N/m]","kt [Nm/rad]"}}]],
(*---Save & Cancel Button---*)
TableForm[{{
Button[Style["Save",Bold],DialogReturn[(save$wire=temp$wire;save$wire2=temp$wire2;)]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]
}],

(*WIRE LIST 2*)
Style["Edit Wire Connection",Bold]->
TableForm[{
(*---Load Lists---*)
...
(*Delete Button*)
With[{n=n},Button[Style["Delete",Small],
temp$wire2=Delete[temp$wire2,{n}],ImageSize->Small]],
With[{n=n},Button[Style["Copy",Small],
AppendTo[temp$wire2,temp$wire2[[n]]],ImageSize->Small]],
...
Number,FieldSize->{4.,1.}],{m,6}]}],
(*Material*)
PopupMenu[With[{n=n},Dynamic[temp$wire2[[n,5]]]],
Table[m->save$mat[[m,1]],{m,Length[save$mat]}]],
(*Length*)
InputField[With[{n=n},Dynamic[temp$wire2[[n,6,1]]]],Number,FieldSize->{5.,1.}],
(*Diameter*)
InputField[With[{n=n},Dynamic[temp$wire2[[n,6,2]]/mm,
(temp$wire2[[n,6,2]]=#*mm)&]],Number,FieldSize->{5.,1.}],
(*Tension*)
InputField[With[{n=n},Dynamic[temp$wire2[[n,7]]]],Number,FieldSize->{5.,1.}]
},{n,Length[temp$wire2]}],TableHeadings->{None,
{"Del","Copy","Edit","Num","U Body","L Body","Clamp Position Parameters [mm]","Material",
"L [m]","D [mm]","T [N]"}}]],
...
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},WindowSize->{800,500},WindowTitle->"2-1 Set Wires", WindowFrameElements->{"ZoomBox"}](*Cancel Button*)
];
...
CreateDialog[{
(*---Title---*)
TextCell[Style["Registrate New Wires",
...
"X-distance between lower SP & lower body's COM [mm]","",""},
num==3,
{"Vertical position of upper SP wrt upper body's CoM [mm]",
"Vertical position of lower SP wrt lower body's CoM [mm]",
"Horizontal radial distance from body's COM [mm]","",
"Rotation angle in the horizontal plane [deg]",""},
num==4,
{"Vertical position of upper SP wrt upper body's CoM [mm]",
"Vertical position of lower SP wrt lower body's CoM [mm]",
"X-distance from body's COM [mm]",
"Z-distance from body's COM [mm]","",
...
mod$ReflectWires:=Module[{temp$newwire},
temp$wire={};
Do[
...
Beep[];CreateDialog[{"Set wires first.",DefaultButton[]},WindowTitle->"Error"];,
(*---Main Dialog---*)
CreateDialog[{
(*---Title---*)
TextCell[Style["Set Vertical Springs",
Bold,Italic,Black],Background->RGBColor[0.6,0.9,0.6]],
(*---New Wire Button---*)
Button[Style["Create New Springs",Bold,White],mod$NewVertSprings,
Appearance->"FramedPalette",Background->Black],
(*---Load Lists---*)
...
Dynamic[TableForm[Table[{
With[{n=n},Button[Style["Delete",Small],
temp$vspr=Delete[temp$vspr,{n}],ImageSize->Small]],
With[{n=n},Button[Style["Copy",Small],
AppendTo[temp$vspr,temp$vspr[[n]]],ImageSize->Small]],
With[{n=n},Button[Style["Edit",Small],mod$EditVertSprings[n],ImageSize->Small]],
InputField[With[{n=n},Dynamic[temp$vspr[[n,8]]]],String,FieldSize->{8.,1.}],
...
InputField[With[{n=n},Dynamic[temp$vspr[[n,3]]]],Number,FieldSize->{5.,1.}],
InputField[With[{n=n},Dynamic[temp$vspr[[n,4]]]],Number,FieldSize->{5.,1.}],
InputField[With[{n=n},Dynamic[temp$vspr[[n,9]]]],Number,FieldSize->{5.,1.}],
TableForm[{{
Checkbox[With[{n=n},Dynamic[temp$vspr[[n,5]]]]],
InputField[With[{n=n},Dynamic[temp$vspr[[n,6]]]],Number,FieldSize->{5.,1.},
Enabled->With[{n=n},Dynamic[temp$vspr[[n,5]]]]]
}}],
TableForm[{Table[InputField[With[{n=n,m=m},
Dynamic[temp$vspr[[n,7,m]]]],Number,FieldSize->{3.,1.}],{m,3}]}]
},{n,Length[temp$vspr]}],TableHeadings->{None,
{"Del","Copy","Edit","Name","Position","k [N/m]","fp [N]","Q","CoP [dB]","Direction"}}]],
(*---Save & Cancel Button---*)
TableForm[{{
Button[Style["Save",Bold],DialogReturn[save$vspr=temp$vspr]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},WindowSize->{800,500},WindowTitle->"2-2 Set Vertical Springs", WindowFrameElements->{"ZoomBox"}](*Cancel Button*)
];
...
CreateDialog[{
(*---Title---*)
TextCell[Style["Registrate New Vertical Springs",
Bold,Italic,White],Background->Black],
...
Bold,Italic,Black],Background->RGBColor[1,0.6,0.6]],
InputField[Dynamic[temp$newvspr[[8]]],String,FieldSize->{8.,1.}],
(*---Choose SP---*)
...
DialogReturn[AppendTo[temp$vspr,temp$newvspr]]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},
...
Bold,Italic,Black],Background->RGBColor[0.6,0.6,0.6]],
TableForm[{{Button[Style["Create",Bold],
DialogReturn[temp$vspr[[nw]]=temp$newvspr]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},
WindowSize->{700,500},WindowTitle->"New Vertical Springs"];
...
CreateDialog[{
(*---Title---*)
TextCell[Style["Set Inverted Pendulum",
Bold,Italic,Black],Background->RGBColor[0.6,0.8,0.6]],
(*---New Wire Button---*)
Button[Style["Create New IPs",Bold,White],mod$NewIP,
Appearance->"FramedPalette",Background->Black],
(*---Load Lists---*)
...
Dynamic[TableForm[Table[{
With[{n=n},Button[Style["Delete",Small],
temp$IP=Delete[temp$IP,{n}],ImageSize->Small]],
With[{n=n},Button[Style["Copy",Small],
AppendTo[temp$IP,temp$IP[[n]]],ImageSize->Small]],
With[{n=n},Button[Style["Edit",Small],
mod$EditIP[n],ImageSize->Small]],
InputField[With[{n=n},Dynamic[temp$IP[[n,6]]]],String,FieldSize->{8.,1.}],
PopupMenu[With[{n=n},Dynamic[temp$IP[[n,1]]]],
Table[m->save$bdn[[m,2]],{m,Length[save$bdn]}]],
PopupMenu[With[{n=n},Dynamic[temp$IP[[n,2]]]],
Table[m->save$bdn[[m,2]],{m,Length[save$bdn]}]]},
{n,Length[temp$IP]}],TableHeadings->{None,
{"Del","Copy","Edit","Name","Base","Top"}}]],
(*---Save & Cancel Button---*)
TableForm[{{
Button[Style["Save",Bold],DialogReturn[save$IP=temp$IP]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},
WindowSize->{800,500},WindowTitle->"2-3 Set Inverted Pendulum"](*Cancel Button*)
];
...
CreateDialog[{
(*---Title---*)
TextCell[Style["Registrate New Inverted Pendulum",
Bold,Italic,White],Background->Black],
...
Bold,Italic,Black],Background->RGBColor[0.6,0.6,1]],
InputField[Dynamic[temp$newIP[[6]]],String,FieldSize->{8.,1.}],
(*---Choose Bodies---*)
...
TableForm[
Table[
{InputField[With[{m=m},Dynamic[temp$newIP[[3,m,1]]/mm,
(temp$newIP[[3,m,1]]=#*mm)&]],Number,FieldSize->{5.,1.}],
InputField[With[{m=m},Dynamic[temp$newIP[[3,m,2]]/mm,
(temp$newIP[[3,m,2]]=#*mm)&]],Number,FieldSize->{5.,1.}]},{m,3}],
TableHeadings->{{"Leg1","Leg2","Leg3"},{"x [mm]","z [mm]"}}],
(*---IP Length---*)
TextCell[Style["Length of IP Legs",
Bold,Italic,Black],Background->RGBColor[0.6,0.7,0.6]],
TableForm[{{InputField[Dynamic[temp$newIP[[7]]/mm,(temp$newIP[[7]]=#*mm)&],
Number,FieldSize->{5.,1.}],"mm"}}],
(*---Load Mass---*)
...
TableForm[{{InputField[Dynamic[temp$newIP[[10]]],
Number,FieldSize->{5.,1.}],"kg"}}],
(*---Stiffness & Q---*)
...
TableForm[
Table[
{InputField[With[{m=m},Dynamic[temp$newIP[[4,m]]]],Number,FieldSize->{5.,1.}],
InputField[With[{m=m},Dynamic[temp$newIP[[5,m]]]],Number,FieldSize->{5.,1.}]},{m,3}],
...
Table[
{InputField[With[{m=m},Dynamic[temp$newIP[[4,m]]]],Number,FieldSize->{5.,1.}],
InputField[With[{m=m},Dynamic[temp$newIP[[5,m]]]],Number,FieldSize->{5.,1.}]},{m,4,4}],
...
InputField[Dynamic[temp$newIP[[8]]],Number,FieldSize->{5.,1.},
Enabled->Dynamic[temp$newIP[[11]]]],"dB"}}],
TableForm[
...
Bold,Italic,Black],Background->RGBColor[0.6,0.6,0.6]],
TableForm[{{Button[Style["Create",Bold],
DialogReturn[AppendTo[temp$IP,temp$newIP]]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},
...
DialogReturn[temp$IP[[n]]=temp$newIP]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},
WindowSize->{700,500},WindowTitle->"New Horizontal Flexure"];
...
If[Not[ValueQ[save$mat]],save$mat=list$Material];
(*---Title---*)
TextCell[Style["Set Horizontal Flexure",
Bold,Italic,Black],Background->RGBColor[0.6,0.8,0.6]],
(*---New Wire Button---*)
...
{"Del","Copy","Name","Base","Follower","Stiffness [Nm/rad]","Material",
"Follower's CoM H[mm]","Position in Base [mm]"}}]],
(*---Save & Cancel Button---*)
TableForm[{{
Button[Style["Save",Bold],DialogReturn[save$hflex=temp$hflex]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},WindowSize->{800,500},WindowTitle->"2-3 Set Horizontal Flexures"](*Cancel Button*)
];
...
CreateDialog[{
(*---Title---*)
TextCell[Style["Set Heat Links",
Bold,Italic,Black],Background->RGBColor[0.6,0.7,0.6]],
(*---New HL Button---*)
Button[Style["Create New Heat Links",Bold,White],mod$NewHeatLinks,
Appearance->"FramedPalette",Background->Black],
(*---Load Lists---*)
...
Dynamic[TableForm[Table[{
With[{n=n},Button[Style["Delete",Small],
temp$HL=Delete[temp$HL,{n}],ImageSize->Small]],
With[{n=n},Button[Style["Copy",Small],
AppendTo[temp$HL,temp$HL[[n]]],ImageSize->Small]],
With[{n=n},Button[Style["Edit",Small],mod$EditHeatLinks[n],ImageSize->Small]],
InputField[With[{n=n},Dynamic[temp$HL[[n,10]]]],String,FieldSize->{8.,1.}],
PopupMenu[With[{n=n},Dynamic[temp$HL[[n,1]]]],
Table[m->save$bdn[[m,2]],{m,Length[save$bdn]}]],
PopupMenu[With[{n=n},Dynamic[temp$HL[[n,2]]]],
Table[m->save$bdn[[m,2]],{m,Length[save$bdn]}]],
TableForm[{Table[InputField[With[{n=n,m=m},Dynamic[temp$HL[[n,3,m]]/mm,
(temp$HL[[n,3,m]]=#*mm)&]],Number,FieldSize->{5.,1.}],{m,3}]}],
TableForm[{Table[InputField[With[{n=n,m=m},Dynamic[temp$HL[[n,4,m]]/mm,
(temp$HL[[n,4,m]]=#*mm)&]],Number,FieldSize->{5.,1.}],{m,3}]}],
InputField[With[{n=n},Dynamic[temp$HL[[n,5,1]]/mm,
(temp$HL[[n,5,1]]=#*mm)&]],Number,FieldSize->{5.,1.}],
InputField[With[{n=n},Dynamic[temp$HL[[n,5,2]]/mm,
(temp$HL[[n,5,2]]=#*mm)&]],Number,FieldSize->{5.,1.}],
InputField[With[{n=n},Dynamic[temp$HL[[n,5,3]]/mm,
(temp$HL[[n,5,3]]=#*mm)&]],Number,FieldSize->{5.,1.}]
...
(*---Save & Cancel Button---*)
TableForm[{{
Button[Style["Save",Bold],DialogReturn[save$HL=temp$HL]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},WindowSize->{800,500},WindowTitle->"2-4 Set Heat Links"](*Cancel Button*)
];
...
TextCell[Style["Name",
Bold,Italic,Black],Background->RGBColor[1,0.6,0.6]],
InputField[Dynamic[temp$newHL[[10]]],String,FieldSize->{8.,1.}],
(*---Bodies---*)
...
InputField[Dynamic[temp$newHL[[6]]],Number,FieldSize->{5.,1.}],"",
Style["Q-factor:",Bold],
InputField[Dynamic[temp$newHL[[7]]],Number,FieldSize->{5.,1.}]}}],
TableForm[Table[
TableForm[
{TableForm[{{
With[{m=m,l=l},Button[Style["Import",Small,Bold],mod$ImportkHL[m,l],
Appearance->"FramedPalette",Background->GrayLevel[.8]]],
InputField[With[{m=m,l=l},Dynamic[temp$newHL[[8,m,l]]]],Number,FieldSize->{5.,1.}]}}],
InputField[With[{m=m,l=l},Dynamic[temp$newHL[[9,m,l]]]],String,
FieldSize->{10.,1.},Enabled->False]}],
{l,6},{m,6}],TableHeadings->Table[{"x","y","z","Pitch","Yaw","Roll"},{2}]],
(*---Create Flexure---*)
TextCell[Style["Finish",
Bold,Italic,Black],Background->RGBColor[0.6,0.6,0.6]],
TableForm[{{Button[Style["Create",Bold],
DialogReturn[AppendTo[temp$HL,temp$newHL]]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},
...
CreateDialog[{
(*---Title---*)
TextCell[Style["Edit Heat Links",
Bold,Italic,White],Background->Black],
(*---New flexure temporary list---*)
...
Bold,Italic,Black],Background->RGBColor[0.6,0.6,0.6]],
TableForm[{{Button[Style["Create",Bold],
DialogReturn[temp$HL[[n]]=temp$newHL]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},
WindowSize->{800,500},WindowTitle->"Edit Heat Links"];
...
Dynamic[TableForm[Table[{
With[{n=n},Button[Style["Delete",Small],
temp$damp=Delete[temp$damp,{n}],ImageSize->Small]],
With[{n=n},Button[Style["Copy",Small],
AppendTo[temp$damp,temp$damp[[n]]],ImageSize->Small]],
With[{n=n},Button[Style["Edit",Small],mod$EditDamper[n],ImageSize->Small]],
InputField[With[{n=n},Dynamic[temp$damp[[n,1]]]],String,FieldSize->{8.,1.}],
PopupMenu[With[{n=n},Dynamic[temp$damp[[n,2]]]],
Table[m->save$bdn[[m,2]],{m,Length[save$bdn]}]],
PopupMenu[With[{n=n},Dynamic[temp$damp[[n,3]]]],
Table[m->save$bdn[[m,2]],{m,Length[save$bdn]}]],
TableForm[{Table[InputField[With[{n=n,m=m},Dynamic[temp$damp[[n,4,m]]/mm,
(temp$damp[[n,4,m]]=#*mm)&]],Number,FieldSize->{5.,1.}],{m,3}]}],
TableForm[{Table[InputField[With[{n=n,m=m},Dynamic[temp$damp[[n,5,m]]/mm,
(temp$damp[[n,5,m]]=#*mm)&]],Number,FieldSize->{5.,1.}],{m,3}]}]
},{n,Length[temp$damp]}],TableHeadings->{None,
{"Del","Copy","Edit","Name","Body1","Body2","Damping Point in Body1 [mm]",
"Damping Point in Body2 [mm]"}}]],
(*---Save & Cancel Button---*)
TableForm[{{
Button[Style["Save",Bold],DialogReturn[save$damp=temp$damp]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},WindowSize->{800,500},WindowTitle->"2-5 Set Damper"](*Cancel Button*)
];
...
TextCell[Style["Name",
Bold,Italic,Black],Background->RGBColor[1,0.6,0.6]],
InputField[Dynamic[temp$newdamp[[1]]],String,FieldSize->{8.,1.}],
(*---Bodies---*)
...
Bold,Italic,Black],Background->RGBColor[0.6,0.6,0.8]],
TableForm[Table[
InputField[With[{m=m,l=l},Dynamic[temp$newdamp[[6,m,l]]]],Number,
FieldSize->{5.,1.}],
{l,6},{m,6}],TableHeadings->Table[{"x","y","z","Pitch","Yaw","Roll"},{2}]],
(*---Create Flexure---*)
TextCell[Style["Finish",
Bold,Italic,Black],Background->RGBColor[0.6,0.6,0.6]],
TableForm[{{Button[Style["Create",Bold],
DialogReturn[AppendTo[temp$damp,temp$newdamp]]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},
WindowSize->{800,500},WindowTitle->"New Heat Links"];
...
Bold,Italic,Black],Background->RGBColor[0.6,0.6,0.6]],
TableForm[{{Button[Style["Create",Bold],
DialogReturn[temp$damp[[n]]=temp$newdamp]],(*Save Button*)
Button["Cancel",DialogReturn[]]}}]},
(*---Dialog Window Setting---*)
WindowElements->{"VerticalScrollBar","HorizontalScrollBar","MagnificationPopUp"},
WindowSize->{800,500},WindowTitle->"New Heat Links"];
